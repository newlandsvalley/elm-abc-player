...
var _newlandsvalley$elm_abc_player$AbcPerformance$translateChord = F3(
	function (state, notes, maybeChordDur) {
		...
		var f = function (abc) {
			...
			var duration = A3(_newlandsvalley$elm_abc_player$Music_Notation$chordalNoteDuration, state.tempo, abc.duration, chordDuration) * state.tempoModifier;
			return {
				time: duration,
		...
		return _elm_lang$core$Native_List.fromArray(
			[
				_newlandsvalley$elm_abc_player$Melody$AChord(
...
var _newlandsvalley$elm_abc_player$AbcPerformance$addNoteToBarAccidentals = F2(
	function (n, accs) {
		...
		if (((_p2.ctor === '_Tuple2') && (_p2._0.ctor === 'Just')) && (_p2._1.ctor === 'Just')) {
			return A3(_newlandsvalley$elm_abc_player$Music_Accidentals$add, _p2._0._0, _p2._1._0, accs);
		} else {
			return accs;
		}
	});
...
var _newlandsvalley$elm_abc_player$AbcPerformance$translateNote = F2(
	function (abc, state) {
		var barAccidentals = state.thisBar.accidentals;
		var duration = A2(_newlandsvalley$elm_abc_player$Music_Notation$noteDuration, state.tempo, abc.duration) * state.tempoModifier;
		var note = A2(
...
var _newlandsvalley$elm_abc_player$AbcPerformance$translateMusic = F2(
	function (m, acc) {
		...
		switch (_p9.ctor) {
			...
			case 'Rest':
				var duration = A2(_newlandsvalley$elm_abc_player$Music_Notation$noteDuration, state.tempo, _p9._0) * state.tempoModifier;
				var note = A2(
					_newlandsvalley$elm_abc_player$Melody$ANote,
			...
			case 'BrokenRhythmPair':
				...
				if (_p11.ctor === 'LeftArrow') {
					...
					var leftStateStart = _elm_lang$core$Native_Utils.update(
						state,
						{
							tempoModifier: 1 - _imeckler$ratio$Ratio$toFloat(
								_newlandsvalley$elm_abc_player$Music_Notation$dotFactor(_p12))
						});
					...
					var leftStateStart = _elm_lang$core$Native_Utils.update(
						...
						{
							tempoModifier: 1 + _imeckler$ratio$Ratio$toFloat(
								_newlandsvalley$elm_abc_player$Music_Notation$dotFactor(_p13))
						});
					var leftStateEnd = A2(_newlandsvalley$elm_abc_player$AbcPerformance$translateNote, _p14, leftStateStart);
					var rightStateStart = _elm_lang$core$Native_Utils.update(
						leftStateEnd,
			...
			case 'Barline':
				...
				var newMelody = function () {
					if (_newlandsvalley$elm_abc_player$AbcPerformance$isEmptyBar(state.thisBar)) {
						...
						return A2(_elm_lang$core$List_ops['::'], state.thisBar, melodyLine);
					}
				}();
...
var _newlandsvalley$elm_abc_player$AbcPerformance$fromAbc = function (tune) {
	...
	var headerState = A3(
		...
		defaultState,
		_elm_lang$core$Basics$fst(tune));
	var _p21 = A3(
		_elm_lang$core$List$foldl,
		f,
		headerState,
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmInternalAccidentalM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
			time: 0.375,
			pitch: 72,
			pc: _elm_lang$core$Maybe$Just(_newlandsvalley$elm_abc_player$Abc_ParseTree$C),
			accidental: _elm_lang$core$Maybe$Just(_newlandsvalley$elm_abc_player$Abc_ParseTree$Natural)
		},
		false),
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
			...
			pitch: 72,
			pc: _elm_lang$core$Maybe$Just(_newlandsvalley$elm_abc_player$Abc_ParseTree$C),
			accidental: _elm_lang$core$Maybe$Nothing
		},
		false),
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmAccidentalM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
			time: 0.375,
			pitch: 74,
			pc: _elm_lang$core$Maybe$Just(_newlandsvalley$elm_abc_player$Abc_ParseTree$D),
			accidental: _elm_lang$core$Maybe$Nothing
		},
		false),
		A2(
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$tripletAccidentalM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceAccidentalM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceTiedM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
		...
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
			time: 0.25,
			pitch: 76,
			pc: _elm_lang$core$Maybe$Just(_newlandsvalley$elm_abc_player$Abc_ParseTree$E),
			accidental: _elm_lang$core$Maybe$Nothing
		},
		false),
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
			time: 0.25,
			pitch: 78,
			pc: _elm_lang$core$Maybe$Just(_newlandsvalley$elm_abc_player$Abc_ParseTree$F),
			accidental: _elm_lang$core$Maybe$Nothing
		},
		true),
		A2(
		...
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
			time: 0.25,
			pitch: 79,
			pc: _elm_lang$core$Maybe$Just(_newlandsvalley$elm_abc_player$Abc_ParseTree$G),
			accidental: _elm_lang$core$Maybe$Nothing
		},
		false)
	]);
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmDownM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmUpM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$tripletM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$chordM = _elm_lang$core$Native_List.fromArray(
	[
		_newlandsvalley$elm_abc_player$Melody$AChord(
		_elm_lang$core$Native_List.fromArray(
			[
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$Melody$ANote,
		{
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmInternalAccidental = 'K: D\r\n| =c>c c |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmAccidental = 'K: D\r\n| d>=c c |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$tripletAccidental = 'K: D\r\n| (3=c2d2c2 |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceAccidental = 'K: D\r\n| =c2d2c2 |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceTied = 'K: D\r\n| def- fg |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmDown = 'K: D\r\n| d>e e |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmUp = 'K: D\r\n| d<e e |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$triplet = 'K: D\r\n| (3def |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$chord = 'K: D\r\n| [def]2 |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequence = 'K: D\r\n| def |\r\n';
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$getMelodyLine = function (s) {
	return _newlandsvalley$elm_abc_player$AbcPerformance$melodyFromAbcResult(
		_newlandsvalley$elm_abc_player$Abc$parse(s));
};
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$getFirstBarNotes = function (s) {
	var melodyResult = _newlandsvalley$elm_abc_player$Test_AbcPerformance$getMelodyLine(s);
	var _p0 = melodyResult;
	if (_p0.ctor === 'Ok') {
		var maybeFirstBar = _elm_lang$core$List$head(_p0._0);
		var _p1 = maybeFirstBar;
		if (_p1.ctor === 'Just') {
			return _p1._0.notes;
		} else {
			return _elm_lang$core$Native_List.fromArray(
...
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$showBar1Notes = function (s) {
	var bar1Notes = _newlandsvalley$elm_abc_player$Test_AbcPerformance$getFirstBarNotes(s);
	if (_elm_lang$core$List$isEmpty(bar1Notes)) {
		return _elm_community$elm_test$ElmTest$assert(false);
	} else {
		var _p2 = A2(_elm_lang$core$Debug$log, 'bar 1 notes', bar1Notes);
		return _elm_community$elm_test$ElmTest$assert(true);
	}
};
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes = F2(
	function (s, target) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			target,
			_newlandsvalley$elm_abc_player$Test_AbcPerformance$getFirstBarNotes(s));
	});
var _newlandsvalley$elm_abc_player$Test_AbcPerformance$tests = function () {
	var melodyLine = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				'sequence',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequence, _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'chord',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$chord, _newlandsvalley$elm_abc_player$Test_AbcPerformance$chordM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'triplet',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$triplet, _newlandsvalley$elm_abc_player$Test_AbcPerformance$tripletM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'broken rhythm up',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmUp, _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmUpM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'broken rhythm down',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmDown, _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmDownM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'tied sequence',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceTied, _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceTiedM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'sequence with accidental',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceAccidental, _newlandsvalley$elm_abc_player$Test_AbcPerformance$sequenceAccidentalM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'triplet with accidental',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$tripletAccidental, _newlandsvalley$elm_abc_player$Test_AbcPerformance$tripletAccidentalM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'broken rhythm with accidental',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmAccidental, _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmAccidentalM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'broken rhythm with internal accidental',
				A2(_newlandsvalley$elm_abc_player$Test_AbcPerformance$assertBar1Notes, _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmInternalAccidental, _newlandsvalley$elm_abc_player$Test_AbcPerformance$brokenRhythmInternalAccidentalM))
			]));
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'ABC Performance',
...
var _newlandsvalley$elm_abc_player$MidiPerformance$translateChord = F3(
	function (state, notes, maybeChordDur) {
		...
		var f = function (abc) {
			var barAccidentals = state.thisBar.accidentals;
			var ticks = A2(_newlandsvalley$elm_abc_player$Music_Notation$chordalNoteTicks, abc.duration, chordDuration);
			return {
				ticks: ticks,
				pitch: A3(_newlandsvalley$elm_abc_player$Music_Notation$toMidiPitch, abc, state.modifiedKeySignature, barAccidentals),
				pc: _elm_lang$core$Maybe$Just(abc.pitchClass),
...
var _newlandsvalley$elm_abc_player$MidiPerformance$translateNote = F2(
	function (abc, state) {
		var barAccidentals = state.thisBar.accidentals;
		var pitch = state.lastNoteTied ? 0 : A3(_newlandsvalley$elm_abc_player$Music_Notation$toMidiPitch, abc, state.modifiedKeySignature, barAccidentals);
		var ticks = ((_newlandsvalley$elm_abc_player$Music_Notation$noteTicks(abc.duration) * _imeckler$ratio$Ratio$numerator(state.tempoModifier)) / _imeckler$ratio$Ratio$denominator(state.tempoModifier)) | 0;
		var note = A2(
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmInternalAccidentalM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmAccidentalM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$tripletAccidentalM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceAccidentalM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceTiedM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmDownM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmUpM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$tripletM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$chordM = _elm_lang$core$Native_List.fromArray(
	[
		_newlandsvalley$elm_abc_player$MidiMelody$MChord(
		_elm_lang$core$Native_List.fromArray(
			[
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceM = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_newlandsvalley$elm_abc_player$MidiMelody$MNote,
		{
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmInternalAccidental = 'K: D\r\n| =c>c c |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmAccidental = 'K: D\r\n| d>=c c |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$tripletAccidental = 'K: D\r\n| (3=c2d2c2 |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceAccidental = 'K: D\r\n| =c2d2c2 |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceTied = 'K: D\r\n| def- fg |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmDown = 'K: D\r\n| d>e e |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmUp = 'K: D\r\n| d<e e |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$triplet = 'K: D\r\n| (3def |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$chord = 'K: D\r\n| [def]2 |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequence = 'K: D\r\n| def |\r\n';
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$getMidiMelody = function (s) {
	return _newlandsvalley$elm_abc_player$MidiPerformance$melodyFromAbcResult(
		_newlandsvalley$elm_abc_player$Abc$parse(s));
};
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$getSecondBarNotes = function (s) {
	var melodyResult = _newlandsvalley$elm_abc_player$Test_MidiPerformance$getMidiMelody(s);
	var _p0 = melodyResult;
	if (_p0.ctor === 'Ok') {
		var tail = A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$List$tail(_p0._0));
		var maybeSecondBar = _elm_lang$core$List$head(tail);
		var _p1 = maybeSecondBar;
		if (_p1.ctor === 'Just') {
			return _p1._0.notes;
		} else {
			return _elm_lang$core$Native_List.fromArray(
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$showBar2Notes = function (s) {
	var bar1Notes = _newlandsvalley$elm_abc_player$Test_MidiPerformance$getSecondBarNotes(s);
	if (_elm_lang$core$List$isEmpty(bar1Notes)) {
		return _elm_community$elm_test$ElmTest$assert(false);
	} else {
		var _p2 = A2(_elm_lang$core$Debug$log, 'bar 1 notes', bar1Notes);
...
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes = F2(
	function (s, target) {
		return A2(
			_elm_community$elm_test$ElmTest$assertEqual,
			target,
			_newlandsvalley$elm_abc_player$Test_MidiPerformance$getSecondBarNotes(s));
	});
var _newlandsvalley$elm_abc_player$Test_MidiPerformance$tests = function () {
	var midiMelody = A2(
		_elm_community$elm_test$ElmTest$suite,
		'MIDI melody',
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_community$elm_test$ElmTest$test,
				'sequence',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequence, _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'chord',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$chord, _newlandsvalley$elm_abc_player$Test_MidiPerformance$chordM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'triplet',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$triplet, _newlandsvalley$elm_abc_player$Test_MidiPerformance$tripletM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'broken rhythm up',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmUp, _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmUpM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'broken rhythm down',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmDown, _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmDownM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'tied sequence',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceTied, _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceTiedM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'sequence with accidental',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceAccidental, _newlandsvalley$elm_abc_player$Test_MidiPerformance$sequenceAccidentalM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'triplet with accidental',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$tripletAccidental, _newlandsvalley$elm_abc_player$Test_MidiPerformance$tripletAccidentalM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'broken rhythm with accidental',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmAccidental, _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmAccidentalM)),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'broken rhythm with internal accidental',
				A2(_newlandsvalley$elm_abc_player$Test_MidiPerformance$assertBar2Notes, _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmInternalAccidental, _newlandsvalley$elm_abc_player$Test_MidiPerformance$brokenRhythmInternalAccidentalM))
			]));
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'MIDI Performance',
...
var _newlandsvalley$elm_abc_player$AllTests$all = A2(
	_elm_community$elm_test$ElmTest$suite,
	'performance tests',
	_elm_lang$core$Native_List.fromArray(
		[_newlandsvalley$elm_abc_player$Test_AbcPerformance$tests, _newlandsvalley$elm_abc_player$Test_MidiPerformance$tests]));
var _newlandsvalley$elm_abc_player$AllTests$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_newlandsvalley$elm_abc_player$AllTests$all)
};

var Elm = {};
Elm['AllTests'] = Elm['AllTests'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['AllTests'], 'AllTests', typeof _newlandsvalley$elm_abc_player$AllTests$main === 'undefined' ? null : _newlandsvalley$elm_abc_player$AllTests$main);
