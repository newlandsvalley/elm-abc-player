...
returnTuneResult r =
    ...
    Task.perform TuneResult (Task.succeed r)
            ...
            Err e ->
                ...
                if (isEmpty e.msgs) then
                    ...
                    let
                        ...
                        endSuffix =
                            Basics.min (e.position + 6) (String.length m.abc)
